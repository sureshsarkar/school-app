...
<?php $__env->startSection("container"); ?>
   ...
   <?php
    ...
    <?php echo $__env->make("front.layouts.banner", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      ...
      <section class="product-wrapper product-page-wrapper">
              <div class="container">
                <div class="row">
                     ...
                     <div class="col-lg-4 col-md-6 col-12">
                         <div class="product-small-box product-page-box">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("front.layouts.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/demo1pro/lighthouse.demo1.projectdigitalhubsolution.com/projects/resources/views/front/static/products.blade.php ENDPATH**/ ?>