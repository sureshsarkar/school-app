...
<?php if(isset($data)): ?>
    ...
    <div class="col-md-12">
        <div class="form-group">
            <?php echo Form::label("Testimonial"); ?>
...
<?php if(isset($data)): ?>
    <?php if( $data->templete=="homeaaaa" ): ?>

    <div class="row">
    <div class="col-md-12">
        <div class="form-group">
            <?php echo Form::label("Investment "); ?>
...
<?php /**PATH F:\Xampp8.0.2\htdocs\aic\projects\resources\views/admin/cms/form.blade.php ENDPATH**/ ?>