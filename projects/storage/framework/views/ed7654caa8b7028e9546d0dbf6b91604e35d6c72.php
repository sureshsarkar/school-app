                        ...
                        <tr>
                            ...
                            <td>
                                    <?php if($client->bannerImage): ?>
                                          <img src="<?php echo e(asset($client->bannerImage)); ?>" width="50" > 
                                    <?php endif; ?>
                            </td>
                            <td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/demo1pro/lighthouse.demo1.projectdigitalhubsolution.com/projects/resources/views/admin/services/index.blade.php ENDPATH**/ ?>