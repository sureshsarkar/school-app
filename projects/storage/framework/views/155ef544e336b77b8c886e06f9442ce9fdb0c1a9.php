<div class="row">
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <?php echo Form::select("name",["Hero Section"=>"Hero Section","Event Details"=>"Event Details","Participate"=>"Participate","Our Partners"=>"Our Partners","Social Media"=>"Social Media","Contact"=>"Contact"],null,["class"=>"form-control","required"=>"required"]); ?>
...
<?php /**PATH /opt/lampp/htdocs/award/projects/resources/views/admin/services/form.blade.php ENDPATH**/ ?>