			...
			<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					<tr>
						...
						<div><span style="display: block; font-size: 30px; font-weight: 600; margin: 20px 0 10px 0; color: #6c3e79; font-family: 'Poppins', sans-serif;">Booking Cancellation</span></div>
						</td>
					</tr>
				</tbody>
			</table>
