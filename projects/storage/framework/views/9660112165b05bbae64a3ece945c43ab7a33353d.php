       ...
       <div
           ...
           <div>
               ...
               <div class="flex items-center gap-[20px] py-[30px] px-[25px] border-b border-edgray/20">
                   <img src="<?php echo e(asset('front/images/cart-item-1.jpg')); ?>" alt="Cart Item Image"
               ...
               <!-- single cart item -->
               <div class="flex items-center gap-[20px] py-[30px] px-[25px] border-b border-edgray/20">
                   <img src="<?php echo e(asset('front/images/cart-item-2.jpg')); ?>" alt="Cart Item Image"
                       class="rounded-[10px] shrink-0">
                   <div class="grow">
                       <h6 class="font-medium text-[18px] text-edblue">
               ...
               <!-- single cart item -->
               <div class="flex items-center gap-[20px] py-[30px] px-[25px] border-b border-edgray/20">
                   <img src="<?php echo e(asset('front/images/cart-item-3.jpg')); ?>" alt="Cart Item Image"
                       class="rounded-[10px] shrink-0">
                   <div class="grow">
                       <h6 class="font-medium text-[18px] text-edblue">
       ...
       <div class="bg-edblue flex items-center justify-between lg:justify-center lg:gap-x-[20px]">
           ...
           <div class="shrink-0 flex items-center gap-x-[30px] xl:gap-x-[15px] text-white lg:order-3 sm:hidden">
               <div class="flex gap-x-[30px] xl:gap-x-[15px]">
                   <a href="<?php echo e(url('user-login')); ?>" class="flex items-center gap-x-[10px] font-light text-white/80">
               ...
               <div class="flex items-center gap-[100px] xl:gap-[30px] lg:gap-y-0">
                   ...
                   <div class="ed-header-nav-container">
                       <ul
                           ...
                           <li>
                               <a href="<?php echo e(url('franchise')); ?>">Franchise</a>
                           </li>
                           <li>
   ...
   <!-- HEADER SECTION END -->
<?php /**PATH D:\xampp\htdocs\laravel\school-app\projects\resources\views/front/layouts/header.blade.php ENDPATH**/ ?>