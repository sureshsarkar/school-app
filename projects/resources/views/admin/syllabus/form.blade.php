<div class="row">
    ...
    <div class="col-md-4">
        <div class="form-group">
            {!! Form::label("Class") !!}
            {!! Form::select("class_id",ModelHelper::getClassSelectList(),null,["class"=>"form-control","placeholder"=>"choose class"]) !!}
    ...
    <div class="col-md-4 ">
        <div class="form-group">
            {!! Form::label("Subject") !!}
            {!! Form::select("subject_id",ModelHelper::getSubjectSelectList(),null,["class"=>"form-control","placeholder"=>"choose subject"]) !!}
