...
<!--banner -->
   <section class="banner-wrapper" style="background-color: #ed7300 !important;height: 600px !important;">

  	 <div class="container">
  	 	<div class="row">
            <div class="home-slider">
                <h2>We’re a small but nimble army of weirdos.</h2>
...
<!-- about -->
    <section class="counter-wrapper" id="about-tomi">
        <div class="container">
            <h2 class="text-white"><?php echo e($data->description); ?></h2>
        ...
        <div class="process-tab-main">
            <div class="row">
                <div class="col-lg-7 col-md-7 col-12">
                    <h3 class="text-white"><?php echo strip_tags($data->shortDescription); ?></h3>
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        ...
                        <div class="tab-pane fade" id="pills-profiles" role="tabpanel" aria-labelledby="pills-profiles-tab">
                         ...
                         $k=0;
                                        ...
                                        ?>
                                        <div class="col-lg-3 col-md-6 col-12 col-padd">
                                            <div class="jury-box <?php echo e($color); ?>">
              ...
              <div class="icon-img">
               <img src="<?php echo e(asset($c->image)); ?>">
                ...
                <?php if($c->seo_url=='company-login'): ?>
                    ...
                    <?php else: ?>
                        <a href="<?php echo e(url("company-ads/".$c->seo_url)); ?>"> <img src="<?php echo e(asset($c->bannerImage)); ?>" alt="<?php echo e($c->title); ?>"></a>
                    <?php endif; ?>
                    <?php else: ?>
                    <a href="<?php echo e(url($c->seo_url)); ?>"> <img src="<?php echo e(asset($c->bannerImage)); ?>" alt="<?php echo e($c->title); ?>"></a>
                <?php endif; ?>
...
<?php echo $__env->make("front.layouts.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/award/projects/resources/views/front/static/home.blade.php ENDPATH**/ ?>