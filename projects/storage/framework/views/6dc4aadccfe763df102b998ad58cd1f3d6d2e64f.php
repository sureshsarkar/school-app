    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
          <?php 
            $addbar=["name"=>$name."s","add-data"=>true,"add-name"=>"Add ".$name,"add-anchor"=>route($route.'.create'),"back-anchor"=>route($route.'.index'),'expot-data'=>route('exportData',$route)];
          ?>
                ...
                <tbody>
                    ...
                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                                    <?php if($client->image): ?>
                                          <img src="<?php echo e(asset($client->image)); ?>" width="100" height="50"> 
                                    <?php endif; ?>
                            </td>
                            <td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("admin.layouts.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mobbindtechnolog/public_html/admin.mobbindtechnology.co.in/projects/resources/views/admin/careers/index.blade.php ENDPATH**/ ?>