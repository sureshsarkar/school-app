                ...
                <tbody>
                    ...
                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><?php echo e($client->parentname->name??''); ?></td>
                            <td>
                            ...
                            <td>
                                ...
                                <?php if($client->parent_id==0): ?>
                                <a href="<?php echo route($route.'.create', ['parent_id'=>$client->id]); ?>" class="btn btn-outline-success btn-sm raw-margin-right-8">Child Category </a>
                                <?php endif; ?>
                                <a href="<?php echo route($route.'.copyData', [$client->id]); ?>" class="btn btn-outline-warning btn-sm raw-margin-right-8"><i
...
<?php echo $__env->make('admin.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Xampp8.0.2\htdocs\pinoy\projects\resources\views/admin/locations/index.blade.php ENDPATH**/ ?>