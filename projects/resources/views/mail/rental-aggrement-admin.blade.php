			...
			<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					<tr>
						...
						<div><span style="display: block; font-size: 30px; font-weight: 600; margin: 20px 0 10px 0; color: #6c3e79; font-family: 'Poppins', sans-serif;">New Rental Agreement</span></div>
						</td>
					</tr>
				</tbody>
			</table>
					...
					<tr>
						...
						<table align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
							<tbody>
								...
								<tr>
									<td align="left" style="padding: 10px; border: 1px solid #6c3e79; font-weight: bold; font-size: 15px; color:#000; border-right:0px solid #6c3e79;" valign="top"><strong>Rental Agreement Signature :</strong></td>
									<td align="left" style="padding: 10px; border: 1px solid #6c3e79; font-weight: bold; font-size: 15px; color:#000;" valign="top">
								...
								<tr>
									<td align="left" style="padding: 10px; border: 1px solid #6c3e79; font-weight: bold; font-size: 15px; color:#000; border-right:0px solid #6c3e79;" valign="top"><strong>Rental Agreement Image :</strong></td>
									<td align="left" style="padding: 10px; border: 1px solid #6c3e79; font-weight: bold; font-size: 15px; color:#000;" valign="top">
								...
								<tr>
									<td align="left" style="padding: 10px; border: 1px solid #6c3e79; font-weight: bold; font-size: 15px; color:#000; border-right:0px solid #6c3e79;" valign="top"><strong>Rental Agreement Link :</strong></td>
									<td align="left" style="padding: 10px; border: 1px solid #6c3e79; font-weight: bold; font-size: 15px; color:#000;" valign="top">
