    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
          @php 
            $addbar=["name"=>$name,"add-data"=>false,"add-name"=>"Add ". Str::singular($name),"add-anchor"=>route($route.'.create'),"add-deactivate"=>true,"add-activate"=>true];
          @endphp
...
<script>
  ...
  $(document).on("click",".deactivate-checkbox",function () {
      ajaxCallCheckBoxDelete("Deactivate","{{ route('deactiveAllCheckboxCoupon') }}","{{ url()->current() }}","Coupon")
  });
