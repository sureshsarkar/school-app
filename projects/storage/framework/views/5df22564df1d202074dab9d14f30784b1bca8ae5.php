...
<?php
    $name="Company Ads";$route="services";
?>
                ...
                <tbody>
                    ...
                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                                <?php echo e($client->company->name??''); ?>

                            </td>
                            <td>
                                <?php echo e($client->campaign_name); ?>
                            ...
                            <td><?php echo e($client->link_work); ?></td>
...
<?php echo $__env->make('admin.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mobbindtechnolog/public_html/tomi.mobbindtechnology.co.in/projects/resources/views/admin/services/index.blade.php ENDPATH**/ ?>