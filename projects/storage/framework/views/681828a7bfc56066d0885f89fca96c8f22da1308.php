<div class="row">
    ...
    <div class="col-md-3 ">
        <div class="form-group">
            <?php echo Form::label("detail sidebar image"); ?>
...
<div class="row d-none">
    <div class="col-md-12">
        <div class="form-group">
            <?php echo Form::label("brochure data"); ?>
...
</div><?php /**PATH /home3/demo1pro/lighthouse.demo1.projectdigitalhubsolution.com/projects/resources/views/admin/locations/form.blade.php ENDPATH**/ ?>