...
<?php if(isset($data)): ?>
    ...
    <div class="col-md-12">
        <div class="form-group">
            <?php echo Form::label("Online Resume"); ?>
...
<?php if(isset($data)): ?>
    ...
    <div class="col-md-12">
        <div class="form-group">
            <?php echo Form::label("Quick Career Tips "); ?>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                <?php echo Form::label("Top Companies "); ?>
...
<?php /**PATH /home/mobbindtechnolog/public_html/admin.mobbindtechnology.co.in/projects/resources/views/admin/cms/form.blade.php ENDPATH**/ ?>