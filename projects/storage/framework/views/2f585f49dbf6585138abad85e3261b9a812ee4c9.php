                            ...
                            <tbody>
                                ...
                                <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo e($client->className->name ?? ''); ?>

                                        </td>
                                        <td>
                                            <?php echo e($client->subjectName->name ?? ''); ?>

                                        </td>
                                        
                                        <td>
                                            <?php if($client->publish == 'published'): ?>
                                                <a href="<?php echo e(route('setPublishData', [$route, $client->id, 'pending'])); ?>"
                                                    class="btn btn-outline-success btn-xs">Unpublished</a>
                                            <?php else: ?>
                                                <a href="<?php echo e(route('setPublishData', [$route, $client->id, 'published'])); ?>"
                                                    class="btn btn-outline-danger btn-xs">Published</a>
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            <a href="<?php echo e(asset($client->image)); ?>" class="btn btn-primary" target="_blank"><i
                                                    class="fa fa-eye"></i></a> 
                                        </td>
...
<?php echo $__env->make('admin.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\laravel\school-app\projects\resources\views/admin/syllabus/index.blade.php ENDPATH**/ ?>