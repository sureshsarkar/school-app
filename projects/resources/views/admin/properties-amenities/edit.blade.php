        ...
        <div class="col-12">
          ...
          <div class="card  ">
            <div class="card-header">
              <h3 class="card-title"><span class="badge badge-primary">{!! $property->name !!}</span> <i class='fa fa-arrow-right'></i> <span class="badge badge-info">{!! $amenity_group->name !!} Group <i class='fa fa-arrow-right'></i> </span>Edit {{ Str::singular($name) }}</h3>
