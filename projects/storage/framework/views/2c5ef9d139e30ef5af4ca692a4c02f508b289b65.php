                    ...
                    <div class="col-md-3 col-lg-3 col-6">
                        ...
                        <div class="image-box">
                            ...
                            <a href="javaScript:;">
                                ...
                                <img src="<?php echo e(asset($c->image)); ?>" alt="<?php echo e($c->name); ?>" title="<?php echo e($c->name); ?>" width="100%" >
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("front.layouts.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/demo1pro/lighthouse.demo1.projectdigitalhubsolution.com/projects/resources/views/front/static/our-clients.blade.php ENDPATH**/ ?>