                    ...
                    @foreach($data as $client)
                        <tr>
                            ...
                            <td>
                                ...
                                @if($client->is_home=="true")
                                    <a href="{{ route('setIsHomeData',[$route,$client->id,'false']) }}" class="btn btn-outline-success btn-xs" >true</a>
                                @else
                                    <a href="{{ route('setIsHomeData',[$route,$client->id,'true']) }}" class="btn btn-outline-danger btn-xs" >false</a>
                                @endif
                            </td>
                            <td>
                                {{ $client->ordering}}
                            ...
                            <td>
                                {{ App\Models\Country::find($client->country_id)->title ?? '' }}
                            </td>
