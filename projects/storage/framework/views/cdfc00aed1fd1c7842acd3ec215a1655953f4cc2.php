                ...
                <div class="row"> 
                    <div class="col-md-4">
                        <div class="bg-white rounded-[10px] p-[24px] shadow-[0_4px_50px_rgba(0,0,0,0.09)]">
                            ...
                            <a href="<?php echo e(url('user/syllabus')); ?>"
                ...
                <div class="row mt-4"> 
                    ...
                    <div class="col-md-4">
                        <div class="bg-white rounded-[10px] p-[24px] shadow-[0_4px_50px_rgba(0,0,0,0.09)]">
                            ...
                            <a href="<?php echo e(url('final-exam?type=final-exam')); ?>"
                                class="ed-btn !h-[40px] !bg-white border !border-edpurple !text-edpurple !text-[14px] !font-semibold hover:!bg-edpurple hover:!text-white">Click Here
                            </a>
                        </div>
                    </div> 
                    ...
                    <div class="col-md-4">
                        <div class="bg-white rounded-[10px] p-[24px] shadow-[0_4px_50px_rgba(0,0,0,0.09)]">
                            ...
                            <a href="<?php echo e(url('adminssion?type=adminssion')); ?>"
                                class="ed-btn !h-[40px] !bg-white border !border-edpurple !text-edpurple !text-[14px] !font-semibold hover:!bg-edpurple hover:!text-white">Click Here
                            </a>
                        </div>
                    </div> 
...
<?php echo $__env->make('front.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\laravel\school-app\projects\resources\views/front/static/home.blade.php ENDPATH**/ ?>