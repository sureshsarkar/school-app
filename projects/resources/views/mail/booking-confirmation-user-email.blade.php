...
<style type="text/css">@media screen {
	...
	@media screen and (max-width: 480px) {
						...
						<div class="accept" class="text-align:center"><span style="display: block; font-size: 30px; font-weight: 600; margin: 20px 0 10px 0; color: #6c3e79; font-family: 'Poppins', sans-serif; text-align:center">Payment Request</span></div>
