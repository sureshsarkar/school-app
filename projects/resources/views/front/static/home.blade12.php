  	 ...
  	 <div class="container">
  	 	<div class="row">
            <div class="home-slider">
                <h3>Let Oman's creativity Inspire.  
Oman's First-Ever Marketing Excellence Awards<br>Doesn't Oman deserve its own marketing awards?
...
<!-- about -->
    <section class="counter-wrapper" id="about-tomi">
        <div class="container">
        ...
        <div class="process-tab-main">
            <div class="row">
                <div class="col-lg-7 col-md-7 col-12">
                    <h3 class="text-white">{!! strip_tags($data->shortDescription) !!}</h3>
          ...
          {{-- <div class="col-lg-2 col-md-2 col-12">
                 ...
                 <ul id="counter">
                   <li>
                     <div class="count-contanet">
                       <span class="count percent" data-count="{{$setting_data['project completed']}}">0</span>
                     <p>Days</p>
                     </div>
                   </li>
                   <li>
                     <div class="count-contanet">
                       <span class="count percent" data-count="{{$setting_data['Working hours']}}">0</span>
                     <p>Hours</p>
                     </div>
                   </li>
                   <li>
                     <div class="count-contanet">
                       <span class="count percent" data-count="{{$setting_data['Experienced Staff']}}">0</span>
                     <p>Minutes</p>
                     </div>
                   </li>
                   <li>
                     <div class="count-contanet">
                       <span class="count percent" data-count="{{$setting_data['Happy Clients']}}">0</span>
                     <p>Seconds</p>
                     </div>
                   </li>
                 </ul>
           ...
           <div class="col-lg-2 col-md-2 col-12">
             <div class="become-img right-img">
              <a href="{{url('/')}}"> <img src="{!! asset($setting_data['footer_logo'] ?? 'images/footer-logo.png') !!}"></a>
             </div>
           </div>--}}
      </div>
...
--}}
                    ...
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="pills-proccess-tab" data-bs-toggle="pill" data-bs-target="#pills-proccess" type="button" role="tab" aria-controls="pills-proccess" aria-selected="true">Process</button>
                        </li>
                        <li class="nav-item" role="presentation">
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade active show" id="pills-proccess" role="tabpanel" aria-labelledby="pills-proccess-tab">
              ...
              <div class="icon-img">
               <img src="{{asset($c->image)}}">
                ...
                @if($c->seo_url=='company-login')
                    ...
                    @else
                        <a href="{{url("company-ads/".$c->seo_url)}}"> <img src="{{asset($c->bannerImage)}}" alt="{{$c->title}}"></a>
                    @endif
                    @else
                    <a href="{{url($c->seo_url)}}"> <img src="{{asset($c->bannerImage)}}" alt="{{$c->title}}"></a>
                @endif
...
{{--
<section class="sponser-wrapp mt-0 mb-5 d-none">
  <div class="container">
    <div class="row">
