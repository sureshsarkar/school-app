<div class="row">
	...
	<div class="col-md-3 d-none">
		<div class="form-group">
			{!! Form::label("country") !!}
			{!! Form::select("country_id",ModelHelper::getcountryList(),null,["class"=>"form-control","placeholder"=>"Choose country"]) !!}
	...
	<div class="col-md-3 d-none">
		<div class="form-group">
			...
			{!! Form::select("product_type",["product"=>"product"],'product',["class"=>"form-control","required"]) !!}
