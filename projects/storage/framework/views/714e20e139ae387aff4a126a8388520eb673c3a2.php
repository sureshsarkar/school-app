    ...
    <section class="home-about-wrapp pt-0">
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-md-5 col-12">
                    <div class="home-abt-img wow fadeInUp">
                        <img src="<?php echo e(asset($data->cta_image)); ?>">
                    </div>
                </div>
                <div class="col-lg-7 col-md-7 col-12">
                    <div class="home-abt-con wow fadeInUp">
...
<?php echo $__env->make("front.layouts.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Xampp8.0.2\htdocs\aic\projects\resources\views/front/static/case-studies-strategic-advisory.blade.php ENDPATH**/ ?>