     ...
     <div class="mx-[19.71%] xxxl:mx-[14.71%] xxl:mx-[9.71%] xl:mx-[5.71%] md:mx-[12px]">
         ...
         <div class="flex flex-wrap justify-between gap-[35px] pt-[100px] pb-[58px] border-b border-white/20">
             ...
             <div class="max-w-[370px] xxs:max-w-full">
                 ...
                 <ul class="space-y-[17px]">
                     <li class="flex items-center gap-[8px]">
                         ...
                         <a href="tel:<?php echo e($setting_data['mobile'] ?? ''); ?>" class="hover:text-edyellow"><?php echo e($setting_data['mobile'] ?? ''); ?>
                     ...
                     <li class="flex items-center gap-[8px]">
                         ...
                         <a href="mailto:<?php echo e($setting_data['email'] ?? ''); ?>" class="hover:text-edyellow"><?php echo e($setting_data['email'] ?? ''); ?>
             ...
             <div>
                 ...
                 <div class="space-y-[18px]">
                     ...
                     <a href="<?php echo e(url('blogs')); ?>" class="flex items-center gap-[10px] opacity-80 hover:text-edyellow">
                         <span class="icon">
                             <img src="https://eccawe.com/backend/themes/default/education/img/double-arrow.svg"
                                 alt="icon">
                         </span>
                     ...
                     <a href="<?php echo e(url('faqs')); ?>" class="flex items-center gap-[10px] opacity-80 hover:text-edyellow">
                         <span class="icon">
                             <img src="https://eccawe.com/backend/themes/default/education/img/double-arrow.svg"
                                 alt="icon">
                         </span>
                     ...
                     <a href="<?php echo e(url('login')); ?>" class="flex items-center gap-[10px] opacity-80 hover:text-edyellow">
                         <span class="icon">
                             <img src="https://eccawe.com/backend/themes/default/education/img/double-arrow.svg"
                                 alt="icon">
                         </span>
             ...
             <div>
                 ...
                 <div class="space-y-[18px]">
                     <a href="<?php echo e(url('#')); ?>" class="flex items-center gap-[10px] opacity-80 hover:text-edyellow">
                         <span class="icon">
                             <img src="https://eccawe.com/backend/themes/default/education/img/double-arrow.svg"
                                 alt="icon">
                         </span>
                 ...
                 <div>
                     ...
                     <div class="flex gap-[20px] mt-[30px]">
                         ...
                         <span class="inline-flex gap-[16px] text-[#d9d9d9]">
                             <a href="<?php echo e($setting_data['facebook'] ?? ''); ?>" class="hover:text-edyellow">
                                 <i class="fa-brands fa-facebook-f">
                                 </i>
                             </a>
                             <a href="<?php echo e($setting_data['twitter'] ?? ''); ?>" class="hover:text-edyellow">
                                 <i class="fa-brands fa-x-twitter">
                                 </i>
                             </a>
                             <a href="<?php echo e($setting_data['linkedin'] ?? ''); ?>" class="hover:text-edyellow">
                                 <i class="fa-brands fa-linkedin-in">
                                 </i>
                             </a>
                             <a href="<?php echo e($setting_data['youtube'] ?? ''); ?>" class="hover:text-edyellow">
         ...
         <div class="flex flex-wrap items-center justify-between gap-[15px] pt-[20px] pb-[50px] text-[#d9d9d9]">
             ...
             <div class="flex flex-wrap gap-[40px] xxs:gap-[15px]">
                 <a href="<?php echo e(url('#')); ?>" class="hover:text-edyellow">Terms & Conditions</a>
                 <a href="<?php echo e(url('#')); ?>" class="hover:text-edyellow">Privacy Policy</a>
             </div>
         </div>
     </div>
 </footer>
...
<?php /**PATH D:\xampp\htdocs\laravel\school-app\projects\resources\views/front/layouts/footer.blade.php ENDPATH**/ ?>