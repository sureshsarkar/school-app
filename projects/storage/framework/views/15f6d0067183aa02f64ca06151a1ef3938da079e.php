                ...
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="login-form-sec">
                        <div class="login-form">
                            ...
                            <form action="<?php echo e(route('employee.forgot.password')); ?>" enctype="multipart/form-data" method="POST">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make("front.layouts.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Xampp8.0.2\htdocs\pinoy\projects\resources\views/front/static/forgot-password.blade.php ENDPATH**/ ?>